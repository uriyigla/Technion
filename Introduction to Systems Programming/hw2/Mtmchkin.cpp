...
Mtmchkin::Mtmchkin(const char* playerName, const Card* cardsArray, int numOfCards): m_player(""){
    ...
    this->m_array= new Card [numOfCards];
...
Mtmchkin::Mtmchkin( Mtmchkin& mtmchkin):
