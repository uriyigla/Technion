...
void requestError(int fd, char *cause, char *errnum, char *shortmsg, char *longmsg, pReq_stats stats)
{
...
void requestServeDynamic(int fd, char *filename, char *cgiargs, pReq_stats stats)
{
    ...
    WaitPid(procc, NULL, 0);
}


void requestServeStatic(int fd, char *filename, int filesize, pReq_stats stats)
{
    int srcfd;
